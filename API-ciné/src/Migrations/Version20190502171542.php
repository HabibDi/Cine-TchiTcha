...
final class Version20190502171542 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE seance (id INT AUTO_INCREMENT NOT NULL, salle_fk_id INT NOT NULL, film_fk_id INT NOT NULL, date DATETIME NOT NULL, heure DATETIME NOT NULL, places_disponibles INT NOT NULL, INDEX IDX_187C5FCA48721AB9 (salle_fk_id), INDEX IDX_187C5FCA3C1BE780 (film_fk_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE seance ADD CONSTRAINT FK_187C5FCA48721AB9 FOREIGN KEY (salle_fk_id) REFERENCES salle (id)');
        $this->addSql('ALTER TABLE seance ADD CONSTRAINT FK_187C5FCA3C1BE780 FOREIGN KEY (film_fk_id) REFERENCES film (id)');
        ...
        $this->addSql('ALTER TABLE reservations ADD CONSTRAINT FK_4DA239BA610A9C FOREIGN KEY (seance_fk_id) REFERENCES seance (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sance DROP FOREIGN KEY FK_187C5FCA3C1BE780');
